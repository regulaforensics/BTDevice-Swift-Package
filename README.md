# BTDevice SDK: API Swift Package

Regula Document Reader SDK is designed for identity verification services that specialize in reading and digital verification of passports, ID cards, driver's licenses, visas, and other ID documents. BTDevice and Document Reader SDKs enable the use of the device [Regula 1120](https://regulaforensics.com/products/document-readers/1120/).
...
```
https://github.com/regulaforensics/BTDevice-Swift-Package
```
...
If you're adding BTDevice SDK Swift Packages to a project for the first time, ignore this notice.
